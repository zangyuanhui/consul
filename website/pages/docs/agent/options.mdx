...
- `-non-voting-server` ((#\_non_voting_server)) <EnterpriseAlert inline /> - **This field 
  is deprecated in Consul 1.9.0. See the [`-read-replica`](#_read_replica) flag instead.**
...
- `non_voting_server` - **This field is deprecated in Consul 1.9.0. See the [`read_replica`](#read_replica) field instead.**
